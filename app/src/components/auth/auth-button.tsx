    ...
    <ConnectKitButton.Custom>
      {({ isConnected, show, address, ensName }) => {
        ...
        if (isSignedIn && data?.address && session?.user?.profile) {
          ...
          return (
            <div className="flex items-center gap-2 pr-2 rounded-full bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 transition-colors">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <DropdownMenuItem onClick={siweSignOut}>
                    Sign Out
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
